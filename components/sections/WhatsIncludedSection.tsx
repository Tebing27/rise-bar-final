// components/sections/WhatsIncludedSection.tsx
...
export default async function WhatsIncludedSection() {
  const content = await getSiteContentAsMap();

  return (
    <section id="kontak-kami" className="bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="font-knewave text-4xl md:text-5xl text-gray-900 tracking-wider text-center mb-12">
          {content.contact_headline || "Hubungi Kami"}
        </h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-6">
            <p className="text-lg text-gray-600">
              {content.contact_subheadline ||
                "Kami dengan senang hati menyambut setiap pertanyaan, masukan, maupun kerja sama."}
            </p>
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <MapPinIcon />
                <div>
                  <h3 className="font-bold text-lg text-gray-800">Alamat</h3>
                  <p className="text-gray-600">
                    {content.contact_address ||
                      "Jalan Sumbersari No 300, Lowokwaru, Kota Malang, Jawa Timur."}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href={`mailto:${content.contact_email || "risebar2025@gmail.com"}`}
                    className="text-gray-600 hover:text-green-600 transition-colors"
                  >
                    {content.contact_email || "risebar2025@gmail.com"}
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {content.contact_phone || "[nomor bisnis]"}
                  </p>
                </div>
              </div>
            </div>
            <div className="border-t border-gray-200 pt-6 mt-6">
              ...
              <div className="flex flex-col space-y-3">
                <a
                  href={content.social_instagram_link || "#"}
                  target="_blank"
                ...
                >
                  <InstagramIcon />
                  <span>
                    {content.social_instagram_handle || "risebar.pkmk"}
                  </span>
                </a>
                <a
                  href={content.social_tiktok_link || "#"}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-600 hover:text-black transition-colors"
                >
                  <TikTokIcon />
                  <span>{content.social_tiktok_handle || "risebar.id"}</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="overflow-hidden rounded-lg shadow-lg border border-gray-200 mb-6">
              <iframe
                src={
                  content.contact_map_url ||
                  "http://googleusercontent.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.428532490527!2d112.6151778153448!3d-7.954549881373979!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7882798c5f3e79%3A0x7b5fabd9f3236e8b!2sUniversitas%20Brawijaya!5e0!3m2!1sen!2sid!4v1628082019478!5m2!1sen!2sid"
                }
                width="100%"
                height="300"
                style={{ border: 0 }}
